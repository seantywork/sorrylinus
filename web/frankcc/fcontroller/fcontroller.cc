...
void Controller::GetIndex(const Request &req, Response &res){
...
void Controller::TestFrankHealth(const Request &req, Response &res){
...
void Controller::GoogleOAuthLogin(const Request &req, Response &res){

    std::string request_uri = "";

    if(DEBUG_MODE == "TRUE"){
        OAUTH_REDIRECT_URI = app_oauth_data["web"]["redirect_uris"][0];
    }else{
        OAUTH_REDIRECT_URI = app_oauth_data["web"]["redirect_uris"][1];
    }
...
void Controller::GoogleOAuthCallback(const Request &req, Response &res){
...
void Controller::SignOut(const Request &req, Response &res){
